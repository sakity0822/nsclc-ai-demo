...
data = [
    ...
    },
    {
        ...
        "PubMedリンク": "https://pubmed.ncbi.nlm.nih.gov/29658856/"
    },
    {
        "ステージ": "2次治療",
        ...
        "PubMedリンク": "https://pubmed.ncbi.nlm.nih.gov/27959700/"
    },
    {
        "ステージ": "2次治療",
        ...
        "PubMedリンク": "https://pubmed.ncbi.nlm.nih.gov/25038797/"
    },
    {
        "ステージ": "3次治療",
        "ドライバー変異": "分子標的薬後",
...
if matched:
    ...
    # PubMedリンクがある場合のみ表示
    if info["PubMedリンク"]:
        st.markdown(f"[🔗 PubMedで根拠を見る]({info['PubMedリンク']})")
